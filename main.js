...
let producto_bon = new Producto(lista_productos[0] , precio , 10);
let producto_brie = new Producto(lista_productos[1] , precio , 10 );
let producto_mat = new Producto(lista_productos[2], precio, 10 );
let producto_roty = new Producto(lista_productos[3], precio, 10 );
let producto_vegetariano = new Producto(lista_productos[4], precio, 10 );
